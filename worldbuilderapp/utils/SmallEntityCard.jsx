...
const typeColors = {
    character: '#a368ff',
    chapter: '#ff8a65', //here we need variations of colors, i don't want them all to have the same color that'll get confusing in the Calendar, this is more like an overlay over the calendar
    era: '#ffb74d', //they can be one color, but i want them to be different from the other colors, this is more like an overlay over the calendar
    scene: '#4fc3f7',
    faction: '#ffb74d',
    item: '#81c784',
    ...
    location: '#64b5f6',
    language: '#7986cb',
    plotpoint: '#9575cd', //here we need variations of colors, i don't want them all to have the same color that'll get confusing in the Calendar
    relationship: '#ffd54f',
    default: '#888'
};
