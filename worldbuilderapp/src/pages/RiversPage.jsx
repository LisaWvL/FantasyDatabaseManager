...
export default function RiverPage() {
    ...
    const [newRiver, setNewRiver] = useState({ name: "", sourceLocationId: null, destinationLocationId: null });
        ...
        <div className="app-container">
            ...
            <div className="card">
                ...
                <input
                    ...
                    onChange={(e) => setNewRiver({ ...newRiver, destinationLocationId: parseInt(e.target.value) })}
                />
