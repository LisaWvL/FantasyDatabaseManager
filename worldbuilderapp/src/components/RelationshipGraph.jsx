...
export default function RelationshipGraph() {
    useEffect(() => {
        CharacterRelationship.find().then(relationships => {
            ...
            const edges = relationships.map(r => ({ from: r.character1Id, to: r.character2Id, label: r.relationshipType }));
            ...
            const graphComponent = <Graph graph={graph} options={options} events={events} style={style} />;
