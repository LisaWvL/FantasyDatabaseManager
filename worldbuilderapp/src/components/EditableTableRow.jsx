...
export default function EditableTableRow({
    ...
    // Save is stable and always has latest formData
    ...
    return (
        <tr ref={rowRef}>
            ...
            <td><input name="relationshipType" value={formData.relationshipType} onChange={handleChange} /></td>
            <td><input name="relationshipDynamic" value={formData.relationshipDynamic} onChange={handleChange} /></td>
            <td>
                <select name="chapterId" value={formData.chapterId} onChange={handleChange}>
                    <option value="">-- Select --</option>
                    {chapters.map(s => <option key={s.id} value={s.id}>{s.chapterName}</option>)}
                </select>
            </td>
            <td>
