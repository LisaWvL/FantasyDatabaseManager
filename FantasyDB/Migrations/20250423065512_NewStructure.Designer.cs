...
namespace FantasyDB.Migrations
{
    ...
    [Migration("20250423065512_NewStructure")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FantasyDB.Entities.Act", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Chapter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Character", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.CharacterRelationship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.ConversationTurn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Currency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Date", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Era", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Faction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.PlotPoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.PriceExample", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.River", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Route", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Scene", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities._Shared.ChapterPlotPoint", b =>
                {
                    b.Property<int>("ChapterId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ChapterId", "PlotPointId");

                    b.HasIndex("PlotPointId");

                    b.ToTable("ChaptersPlotPoints");
                });

            modelBuilder.Entity("FantasyDB.Entities._Shared.LanguageLocation", b =>
                {
                    b.Property<int>("LanguageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities._Shared.PlotPointRiver", b =>
                {
                    b.Property<int>("PlotPointId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities._Shared.PlotPointRoute", b =>
                {
                    b.Property<int>("PlotPointId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FantasyDB.Entities.Act", b =>
                {
                    b.HasOne("FantasyDB.Entities.Book", "Book")
                        .WithMany("Acts")
            ...
            modelBuilder.Entity("FantasyDB.Entities.Chapter", b =>
                {
                    b.HasOne("FantasyDB.Entities.Act", "Act")
                        .WithMany("Chapters")
                        .HasForeignKey("ActId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FantasyDB.Entities.Date", "EndDate")
                        .WithMany()
                        .HasForeignKey("EndDateId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FantasyDB.Entities.Character", "POVCharacter")
                        .WithMany()
                        .HasForeignKey("POVCharacterId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FantasyDB.Entities.Date", "StartDate")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyDB.Entities.Character", b =>
                {
                    b.HasOne("FantasyDB.Entities.Date", "BirthDate")
                        .WithMany()
                        .HasForeignKey("BirthDateId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FantasyDB.Entities.Chapter", "Chapter")
                        .WithMany()
                        .HasForeignKey("ChapterId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FantasyDB.Entities.Faction", "Faction")
                        .WithMany()
                        .HasForeignKey("FactionId");

                    b.HasOne("FantasyDB.Entities.Language", "Language")
                        .WithMany()
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FantasyDB.Entities.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyDB.Entities.CharacterRelationship", b =>
                {
                    ...
                    b.HasOne("FantasyDB.Entities.Character", "Character1")
                        .WithMany()
                        .HasForeignKey("Character1Id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FantasyDB.Entities.Character", "Character2")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyDB.Entities.ConversationTurn", b =>
                {
                    b.HasOne("FantasyDB.Entities.PlotPoint", "PlotPoint")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyDB.Entities.Event", b =>
                {
                    ...
                    b.HasOne("FantasyDB.Entities.PlotPoint", null)
                        .WithMany("Events")
                        .HasForeignKey("PlotPointId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("FantasyDB.Entities.Faction", b =>
                {
                    ...
                    b.HasOne("FantasyDB.Entities.Character", "Founder")
                        .WithMany()
                        .HasForeignKey("FounderId");

                    b.HasOne("FantasyDB.Entities.Location", "HQLocation")
                        .WithMany()
                        .HasForeignKey("HQLocationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FantasyDB.Entities.Character", "Leader")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyDB.Entities.Item", b =>
                {
                    ...
                    b.HasOne("FantasyDB.Entities.Character", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyDB.Entities.Location", b =>
                {
                    ...
                    b.HasOne("FantasyDB.Entities.Location", "ParentLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyDB.Entities.River", b =>
                {
                    b.HasOne("FantasyDB.Entities.Location", "DestinationLocation")
                        .WithMany()
                        .HasForeignKey("DestinationLocationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FantasyDB.Entities.Location", "SourceLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyDB.Entities.Route", b =>
                {
                    b.HasOne("FantasyDB.Entities.Location", "From")
                        .WithMany()
                        .HasForeignKey("FromId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FantasyDB.Entities.Location", "To")
                        .WithMany()
                        .HasForeignKey("ToId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("FantasyDB.Entities._Shared.ChapterPlotPoint", b =>
                {
                    b.HasOne("FantasyDB.Entities.Chapter", "Chapter")
                        .WithMany("ChapterPlotPoints")
                        .HasForeignKey("ChapterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FantasyDB.Entities.PlotPoint", "PlotPoint")
                        .WithMany("PlotPointChapters")
                        .HasForeignKey("PlotPointId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("FantasyDB.Entities._Shared.PlotPointRiver", b =>
                {
                    ...
                    b.HasOne("FantasyDB.Entities.River", "River")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyDB.Entities._Shared.PlotPointRoute", b =>
                {
                    ...
                    b.HasOne("FantasyDB.Entities.Route", "Route")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyDB.Entities.Chapter", b =>
                {
                    b.Navigation("ChapterPlotPoints");
            ...
            modelBuilder.Entity("FantasyDB.Entities.PlotPoint", b =>
                {
                    ...
                    b.Navigation("PlotPointChapters");
