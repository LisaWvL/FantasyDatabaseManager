...
import { usePlotPointEntities } from '../../hooks/usePlotPointEntities'; // ✅ make sure this is imported
...
export default function PlotPointCard({
    ...
    const handleDragStart = (e) => {
        if (isGhost) return;
        const idStr = String(plotPoint.id);
        e.dataTransfer.setData('plotPointId', idStr); // for Date drop
                ...
                <>
                    ...
                    {showTooltip && (
                        <div className="plotpoint-tooltip">
                            <strong>Start:</strong> {plotPoint.startDateName || 'Unknown'} <br />
